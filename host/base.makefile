...
# raw_measure_time_files   = $(patsubst raw_measure_time.csv,measure_time.txt,  $(orig_measure_time_files))

raw_measure_files        = $(raw_measure_power_files) # $(raw_measure_time_files)

 ...
 */
extern void time_add_ms(struct timespec *t, long ms);

/** Adds ms microseconds to the value contained in t.
 */
extern void time_add_us(struct timespec *t, long us);

/** Adds ms nanoseconds to the value contained in t.
 */
extern void time_add_ns(struct timespec *t, long ns);

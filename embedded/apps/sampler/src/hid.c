...
/*
static void register_error(hid_device *device __attribute((unused)),
                           const char *op __attribute((unused))) {}
*/
...
hid_get_indexed_string(hid_device *dev __attribute((unused)),
                       int string_index __attribute((unused)),
                       wchar_t *string __attribute((unused)),
                       size_t maxlen __attribute((unused))) {
    return -1;
}
